...
Pos Knight::getLegalMoves(int rr, int cc, string board[8][8]) {
...
Pos Pawn::getLegalMoves(int rr, int cc, string board[8][8]) {
...
Pos Bishop::getLegalMoves(int rr, int cc, string board[8][8]) {
...
Pos Rook::getLegalMoves(int rr, int cc, string board[8][8]) {
...
Pos Queen::getLegalMoves(int rr, int cc, string board[8][8]) {
...
Pos King::getLegalMoves(int rr, int cc, string board[8][8]) {
